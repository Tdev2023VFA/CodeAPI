                ...
                <div class="col-12 col-sm-6 col-md-3">
                    <div class="info-box mb-3">
                        ...
                        <div class="info-box-content">
                            ...
                            <span class="info-box-number"><?=format_cash($NNL->num_rows("SELECT * FROM `users`"))?> thành viên</span>
                        </div>
                    </div>
                </div>
                <div class="col-12 col-sm-6 col-md-3">
                    <div class="info-box mb-3">
                        ...
                        <div class="info-box-content">
                            ...
                            <span class="info-box-number"><?=format_cash($NNL->get_row("SELECT SUM(`money`) FROM `users` ")['SUM(`money`)']);?>đ</span>
                        </div>
                    </div>
                </div>
                <div class="col-12 col-sm-6 col-md-3">
                    <div class="info-box mb-3">
                        ...
                        <div class="info-box-content">
                            ...
                            <span class="info-box-number">Admin: <?=format_cash($NNL->num_rows("SELECT * FROM `users` WHERE `level`='admin'"))?></span>
                        </div>
                    </div>
                </div>
                <div class="col-12 col-sm-6 col-md-3">
                    <div class="info-box mb-3">
                        ...
                        <div class="info-box-content">
                            ...
                            <span class="info-box-number"> <?=format_cash($NNL->num_rows("SELECT * FROM `users` WHERE `banned`='1'"))?> tài khoản</span>
                        </div>
                    </div>
                </div>
                                            ...
                                            <td>
                                                <ul>
                                                    ...
                                                    <li>Hoạt động gần đây:
                                                        <b><?=date('H:i:s d-m-Y',$row['time_session'])?></b></li>
                                                </ul>
                                            </td>
                                            <td>
                                                <a aria-label=""
                                                    href="<?=BASE_URL('admin/ListUsers/Edit/')?><?=$row['id']?>"
                                                    style="color:white;"
...
function RemoveRow(id) {
    cuteAlert({
        ...
        if (e) {
            $.ajax({
                url: "<?=BASE_URL('')?>assets/ajaxs/admin/removeUser.php",
                method: "POST",
                dataType: "JSON",
                data: {
                    id: id
