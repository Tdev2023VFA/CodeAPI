                            ...
                            <ul class="nav nav-tabs" id="custom-tabs-three-tab" role="tablist">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" id="custom-tabs-three-profile-tab" data-toggle="pill"
                                        ...
                                        aria-controls="custom-tabs-three-profile" aria-selected="false">TPBANK AUTO</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="custom-tabs-three-profile-tab" data-toggle="pill"
                            ...
                            <div class="tab-content" id="custom-tabs-three-tabContent">
                                            ...
                                            <div class="col-lg-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="title"
                                                        value="<?=$NNL->site('title')?>" placeholder="VD: sieuthicode.net">
                                                </div>
                                            </div>
                                            <div class="col-lg-4">
                                                <div class="form-group">
                                            ...
                                            <div class="col-lg-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="keywords"
                                                        value="<?=$NNL->site('keywords')?>"
                                                        placeholder="VD: api momo..">
                                                </div>
                                            </div>
                                            <div class="col-lg-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="author"
                                                        value="<?=$NNL->site('author')?>" placeholder="VD: Nguyễn Nhật Lộc">
                                                </div>
                                            </div>
                                            <div class="col-lg-4">
                                                <div class="form-group">
                                            ...
                                            <div class="col-lg-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="hotline"
                                                        value="<?=$NNL->site('hotline')?>" placeholder="Số điện thoại liên hệ">
                                                </div>
                                            </div>
                                            <div class="col-lg-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="email" class="form-control" name="email"
                                                        value="<?=$NNL->site('email')?>" placeholder="Email liên hệ">
                                                </div>
                                            </div>
                                            <div class="col-lg-4">
                                                <div class="form-group">
                                            ...
                                            <div class="col-lg-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="pass_email_smtp"
                                                        value="<?=$NNL->site('pass_email_smtp')?>" placeholder="Nhập mật khẩu Email">
                                                </div>
                                            </div>
                                            <div class="col-lg-4">
                                                <div class="form-group">
                                            ...
                                            <div class="col-lg-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" class="form-control" name="min_recharge"
                                                        value="1000" placeholder="VD 10000">
                                                    <i>Số tiền nạp tối thiểu để được tạo hoá đơn nạp tiền.</i>
                                                </div>
                                            </div>
                                            <div class="col-lg-4">
                                                <div class="form-group">
                                                    <label for="exampleInputEmail1">Key Captcha</label>
                                                    <input type="text" class="form-control" name="key_captcha"
                                                        value="<?=$NNL->site('key_captcha')?>" placeholder="Nhập mật key captcha">
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="tab-pane fade" id="custom-tabs-three-profile" role="tabpanel"
                                    ...
                                    <form action="" method="POST">
                                        <div class="form-group">
                                            <label>Status</label>
                                            <select class="form-control select2bs4" name="status_tpbank">
                                                <option value="1"
                                                    <?= $NNL->site('status_tpbank') == '1' ? 'selected' : '' ?>>
                                                    Bật
                                                </option>
                                                <option value="0"
                                                    <?= $NNL->site('status_tpbank') == '0' ? 'selected' : '' ?>>
                                                    Tắt
                                                </option>
                                            </select>
                                        ...
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">Token Bank (<a type="button"
                                                    ...
                                                    hướng dẫn</a>)</label>
                                            <input type="text" class="form-control" name="token_tpbank"
                                                value="<?= $NNL->site('token_tpbank') ?>"
                                    ...
                                    <form action="" method="POST">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control select2bs4" name="status_momo">
                                                <option value="1"
                                                    <?= $NNL->site('status_momo') == '1' ? 'selected' : '' ?>>
                                                    Bật
                                                </option>
                                                <option value="0"
                                                    <?= $NNL->site('status_momo') == '0' ? 'selected' : '' ?>>
                                                    Tắt
                                                </option>
                                            </select>
                                    ...
                                    <form action="" method="POST">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control select2bs4" name="status_thesieure">
                                                <option value="1"
                                                    <?= $NNL->site('status_thesieure') == '1' ? 'selected' : '' ?>>
                                                    Bật
                                                </option>
                                                <option value="0"
                                                    <?= $NNL->site('status_thesieure') == '0' ? 'selected' : '' ?>>
                                                    Tắt
                                                </option>
                                            </select>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="token_thesieure"
                                                value="<?= $NNL->site('token_thesieure') ?>"
                        ...
                        <div class="card card-primary card-outline">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <textarea id="thongbao" name="thongbao"></textarea>
                                </div>
                            </div>
