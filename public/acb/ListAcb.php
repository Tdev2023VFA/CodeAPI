...
$title = 'DANH SÁCH TÀI KHOẢN ACB | ' . $NNL->site('title');
        ...
        <div class="wrapper-box">
            ...
            <div class="content">
                <h2 class="intro-y text-lg font-medium mt-10">
                    Danh sách tài khoản ACB </h2>
                <div class="grid grid-cols-12 gap-6 mt-5">
                    <div class="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2">
                        <button onclick="window.location.href='<?= BASE_URL('acb/addacb') ?>'" class="btn btn-primary shadow-md mr-2" type="button">Thêm tài khoản ACB</button>
                    </div>
                    <!-- BEGIN: Data List -->
