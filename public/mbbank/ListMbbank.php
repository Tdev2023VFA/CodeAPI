        ...
        <div class="wrapper-box">
            ...
            <div class="content">
                <h2 class="intro-y text-lg font-medium mt-10">
                    Danh sách tài khoản MbBank </h2>
                <div class="grid grid-cols-12 gap-6 mt-5">
                    <div class="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2">
                        <button onclick="window.location.href='<?= BASE_URL('mbbank/Addmbbank') ?>'" class="btn btn-primary shadow-md mr-2" type="button">Thêm tài khoản MBBank</button>
                    </div>
                    <!-- BEGIN: Data List -->
                    <div class="intro-y col-span-12 overflow-auto lg:overflow-visible">
                        <table class="table table-report -mt-2" id="mytable">
                            ...
                            <tbody>
                                <?php
                                $getData = $NNL->get_list("SELECT * FROM `account_mbbank` where `username`='" . $getUser['username'] . "'");
                                foreach ($getData as $mbbank) { ?>
                                    <tr class="intro-x">
                                        ...
                                        <td class="font-medium whitespace-nowrap"><?= $mbbank['stk'] ?></td>
                                        <td class="font-medium whitespace-nowrap"><?= format_cash(getMoney_mbbank($mbbank['token'])) ?>đ</td>
                                        ...
                                        <td class="font-medium whitespace-nowrap">
                                            <div class="flex">
                                                ...
                                                href="<?= BASE_URL('mbbank/history/') ?><?= $mbbank['stk'] ?>"> <i
