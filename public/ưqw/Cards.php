<?php
    ...
    $title = 'QUẢN LÝ NẠP THẺ | '.$NNL->site('tenweb');
                    ...
                    <div class="card-body">
                        <form action="" method="POST">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <div class="form-line">
                                        <input type="text" name="partnerid" value="<?=$NNL->site('partnerid');?>"
                                            class="form-control">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-sm-3 col-form-label">PartnerKey</label>
                                <div class="col-sm-9">
                                    <div class="form-line">
                                        <input type="text" name="partnerkey" value="<?=$NNL->site('partnerkey');?>"
                                            class="form-control">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <div class="form-line">
                                        <input type="text" name="ck_card" value="<?=$NNL->site('ck_card');?>"
                                            class="form-control">
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-sm-9">
                                    <div class="form-line">
                                        <textarea class="textarea"
                                            name="luuy_naptien"><?=$NNL->site('luuy_naptien');?></textarea>
                                    </div>
                                </div>
                            </div>
